					...
					<c:forEach var="cartOrder" items="${cartOrderList}">
						<div class="row">
							<div class="col">
								...
								<div class="cart_info_columns clearfix">
									<div class="cart_info_col cart_info_col_product">Cart
										Order: #${cartOrder.id}</div>
									<div class="cart_info_col cart_info_col_price">Day
										Purchased: ${cartOrder.dayBuy}</div>
									<div class="cart_info_col cart_info_col_quantity">Status:
										${cartOrder.status}</div>
								</div>
							</div>
						</div>
						...
						<c:forEach var="item" items="${allCartItemMap}">
							<c:if test="${cartOrder.id eq item.key}">
								<c:forEach var="cartItemList" items="${item.value}">
												...
												<div class="cart_item_quantity">
													<div class="product_quantity_container">
														<div class="product_quantity clearfix">
															<span>x ${cartItemList.value.quantityInCart}</span>
														</div>
													</div>
												</div>
												<!-- Total -->
