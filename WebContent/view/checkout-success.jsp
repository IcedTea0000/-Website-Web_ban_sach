...
<link rel="${pageContext.request.contextPath}/view/stylesheet"
	type="text/css" href="styles/bootstrap4/bootstrap.min.css">
<link
				...
				<div class="col-lg-6">
					<div class="billing checkout_section">
						...
						<div class="button order_button">
							<a href="${pageContext.request.contextPath}/book-list">View
								more items</a>
							<button type="submit" />
						</div>
